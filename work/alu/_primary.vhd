...
entity alu is
    generic(
        ...
        \sll\           : vl_logic_vector(0 to 3) := (Hi0, Hi0, Hi1, Hi0);
        slt             : vl_logic_vector(0 to 3) := (Hi0, Hi0, Hi1, Hi1);
        sltu            : vl_logic_vector(0 to 3) := (Hi0, Hi1, Hi0, Hi0);
        xxor            : vl_logic_vector(0 to 3) := (Hi0, Hi1, Hi0, Hi1);
        \srl\           : vl_logic_vector(0 to 3) := (Hi0, Hi1, Hi1, Hi0);
        \sra\           : vl_logic_vector(0 to 3) := (Hi0, Hi1, Hi1, Hi1);
        oor             : vl_logic_vector(0 to 3) := (Hi1, Hi0, Hi0, Hi0);
        aand            : vl_logic_vector(0 to 3) := (Hi1, Hi0, Hi0, Hi1)
    );
    port(
