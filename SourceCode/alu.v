module alu (
  ...
  wire overflow;
  assign overflow = (i_op_a[31] & ~i_op_b[31] & ~s[31]) |
                    (~i_op_a[31] &  i_op_b[31] &  s[31]);

  //SLL
  wire [31:0] sll1, sll2, sll3, sll4, sll5, sll_out;
  ...
  //SRL
  wire [31:0] srl1, srl2, srl3, srl4, srl5, srl_out;
  ...
  //SRA
  wire [31:0] sra1, sra2, sra3, sra4, sra5, sra_out;
